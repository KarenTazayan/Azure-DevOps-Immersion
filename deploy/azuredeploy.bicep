...
var appName = '${appNamePrefix}-${nameSuffix}'
    ...
    accessPolicies: [
      {
        ...
        objectId: reference(appShoppingApp.id, '2020-06-01', 'full').identity.principalId
        permissions: {
          keys: [
            'get'
            'create'
...
resource appShoppingApp 'Microsoft.Web/sites@2021-03-01' = {
  name: appName
  location: location
  kind: 'app'
  identity: {
